...
void PreparePlane(Water1 *water,ShProgram1 *shaderMain, float xw, float yw, int resolution)
{
    ...
    for (float i = 0; i < resolution; i++)//z
    {
        for (float j = 0; j < resolution; j++)//x
        {
            ...
            water->ColorObj[VCount]  =(vec3){0.1,0.1,0.9};
            water->ColorObj[VCount+1]=(vec3){0.1,0.1,0.9};
            water->ColorObj[VCount+2]=(vec3){0.1,0.1,0.9};
            water->ColorObj[VCount+3]=(vec3){0.1,0.1,0.9};
            water->ColorObj[VCount+4]=(vec3){0.1,0.1,0.9};
            water->ColorObj[VCount+5]=(vec3){0.1,0.1,0.9};
